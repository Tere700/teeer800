...
<html data-wf-page="6503f66368763805040cc82b" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>Coupon</title>
...
<body>
  <div class="preloader">
    <div class="loading-icon"><img src="/springdemo/images/preloader.gif" alt="" class="preloader-icon"></div>
  </div>
  <div class="page-wrap888y-copy">
            ...
            <nav role="navigation" class="nav-menu w-nav-menu">
              ...
              <div data-hover="false" data-delay="0" class="dropdown w-dropdown">
                ...
                <nav class="w-dropdown-list">
                  ...
                  <a href="/springdemo/account-details/coupon.html" aria-current="page" class="dropdown-link-4 w-dropdown-link w--current">我的優惠卷</a>
    ...
    <section class="team-circles-417py">
      <div class="con99py">
        ...
        <div class="team-grid">
        <c:forEach var="" items="coupon"></c:forEach>
          <th:block th:each="coupon : ${coupons}">
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701df-040cc82b" class="team-card"><img src="/springdemo/images/372386775_1308103069839317_3777264582372536135_n-removebg-preview.png" loading="lazy" alt="" class="team-member-image">
            <div class="team-member-name" th:text="${coupon.discount_type}"></div>
            <div class="team-member-position">
             <span th:text="${coupon.discount_type}"></span><br>
             不得與其他折價優惠同時使用。
             </div>
            <p class="paragraph-4" th:text="${coupon.valid_from} + ' 到 ' + ${coupon.valid_to} + ' 前有效'"></p>
          </div>
          </th:block>
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701ea-040cc82b" class="team-card"><img src="/springdemo/images/372600610_797590695442758_7915769027370116754_n-removebg-preview.png" loading="lazy" alt="" class="team-member-image">
          ...
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701f4-040cc82b" class="team-card"><img src="/springdemo/images/372674854_290450316951089_5584595248934136422_n-removebg-preview.png" loading="lazy" alt="" class="team-member-image">
            <div class="team-member-name">返校折價66%</div>
            <div class="team-member-position">返校折價優惠66%<br>不得與其他折價優惠同時使用。</div>
            <p class="paragraph-6">到2023/10/31, 12:00:00PM前有效</p>
          </div>
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701fe-040cc82b" class="team-card"><img src="/springdemo/images/372551420_1434925397363359_7510774798186496179_n-removebg-preview.png" loading="lazy" alt="" class="team-member-image">
            <div class="team-member-name">返校折價66%</div>
            <div class="team-member-position">返校折價優惠66%<br>不得與其他折價優惠同時使用。</div>
            <p class="paragraph-7">到2023/10/31, 12:00:00PM前有效</p>
          </div>
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf470208-040cc82b" class="team-card"><img src="/springdemo/images/372919840_2136606510004716_7751145998842007823_n-removebg-preview.png" loading="lazy" alt="" class="team-member-image">
            <div class="team-member-name">返校折價66%</div>
            <div class="team-member-position">返校折價優惠66%<br>不得與其他折價優惠同時使用。</div>
            <p class="paragraph-7">到2023/10/31, 12:00:00PM前有效</p>
          </div>
          <div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf470212-040cc82b" class="team-card"><img src="/springdemo/images/373460329_841788514013942_6064721930173980859_n-removebg-preview.png" loading="lazy" alt="" class="team-member-image">
            <div class="team-member-name">返校折價66%</div>
            <div class="team-member-position">返校折價優惠66%<br>不得與其他折價優惠同時使用。</div>
            <p class="paragraph-7">到2023/10/31, 12:00:00PM前有效</p>
          </div>
      ...
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="6503f66368763805040cc82b" data-wf-element-id="c4bd483b-2037-1d4e-3dd3-6bef3b460033">
